...
- 将每条用户反馈归类到预定义的精细分类框架中，确保分类准确、一致且覆盖全面。
    ...
    3. 重要限制：
        - 新的一级属性（content_structure_body_category）数量请勿超出20个。
        - 每个一级属性下的二级属性（content_structure_sub_body）请勿超出10个。
...
{
  "content_structure_body_new": [
    {
      "content_structure_body_category": string,
      "content_structure_sub_body": [
        string,
        string
      ] 
    }
