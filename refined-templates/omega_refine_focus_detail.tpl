...
- 将每条用户反馈归类到预定义的精细分类框架中，确保分类准确、一致且覆盖全面。
    ...
    3. 重要限制：
        - 新的一级属性（consumer_topic_focus_category）数量请勿超出20个。
        - 每个一级属性下的二级属性（consumer_topic_sub_focus）请勿超出20个。
...
{
  "consumer_topic_focus_new": [
    {
      "consumer_topic_focus_category": string,
      "consumer_topic_sub_focus": [
        string,
        string
      ] 
    }
